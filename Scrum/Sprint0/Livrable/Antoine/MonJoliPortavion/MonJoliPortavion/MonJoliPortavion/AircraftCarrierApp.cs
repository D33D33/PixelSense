...
namespace MonJoliPortavion
{
    ...
    /// </summary>
    public class AircraftCarrierApp : Microsoft.Xna.Framework.Game
    {
        private readonly GraphicsDeviceManager graphics;
        private SpriteBatch spriteBatch;

        private AircraftCarrier _charlesDeGaule;

        private TouchTarget touchTarget;
        private Color backgroundColor = new Color(0, 102, 255);
        ...
        protected override void LoadContent()
        {
            ...
            _charlesDeGaule.LoadContent(Content, "textureporteavion");
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            _charlesDeGaule.HandleInput(touchTarget);
            _charlesDeGaule.Update(gameTime);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Begin();
            _charlesDeGaule.Draw(spriteBatch, gameTime);
            spriteBatch.End();
            base.Draw(gameTime);
        }
