...
namespace SurfaceAppTest
{
    ...
    public class App1 : Microsoft.Xna.Framework.Game
    {
        ...
        public Rectangle hitbox(int X, int Y, int width, int height)
        {
        ...
        protected override void Update(GameTime gameTime)
        {
            if (ApplicationServices.WindowAvailability != WindowAvailability.Unavailable)
            {
                ...
                Rectangle hitboxRaquetteGauche = hitbox((int)raquetteGauchePosition.X, (int)raquetteGauchePosition.Y, raquetteGauche.Width, raquetteGauche.Height);
                Rectangle hitboxRaquetteDroite = hitbox((int)raquetteDroitePosition.X, (int)raquetteDroitePosition.Y, raquetteDroite.Width, raquetteDroite.Height);
                ...
                else if (BignouDep.X < 0 && hitboxRaquetteGauche.Contains((int)BignouPosition.X, (int)BignouPosition.Y + raquetteGauche.Height))
                {
                    Console.WriteLine("Bignou is a Fucking shit at Left!");
                    BignouDep.X = -BignouDep.X;
                    _ballBounceWall.Play();
                }
                else if(BignouDep.X > 0 && hitboxRaquetteDroite.Contains((int)BignouPosition.X + raquetteDroite.Width, (int)BignouPosition.Y + raquetteDroite.Height)){
                    Console.WriteLine("Bignou is a Fucking shit at Right!");
                    BignouDep.X = -BignouDep.X;
                    _ballBounceWall.Play();
                }
